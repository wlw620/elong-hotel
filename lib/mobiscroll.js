    ...
    function Scroller(elem, settings) {
        ...
        function generateWheelItems(i) {
            ...
            for (j in warr[i]) {
                ...
                html += '<div class="dw-li dw-v" data-val="' + j + '" style="height:' + hi + 'px;line-height:' + hi + 'px;"><div class="dw-i">' + warr[i][j]+label[i]+ '</div></div>';
                l++;
            }
            html += '</div>';
            return html;
...
//(function ($) {
    ...
    */
    ms.parseDate = function (format, value, settings) {
        ...
        if (!format || (!value&&!settings.defaultValue)) {
            return def;
        }
        if(value == "") value=settings.defaultValue;
